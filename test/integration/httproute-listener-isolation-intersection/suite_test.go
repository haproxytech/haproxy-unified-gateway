...
package httprouteisolationwithintersection
...
type HTTPRouteIsolationSuite struct {
	base.BaseSuite
}

func (s *HTTPRouteIsolationSuite) SetupSuite() {
	s.BaseSuite.SetupSuite("", 0)
}

func (s *HTTPRouteIsolationSuite) TearDownSuite() {
	s.BaseSuite.TearDownSuite()
}

func (s *HTTPRouteIsolationSuite) expectConditionsUpdated(ctx context.Context, namespace, name string, expectedConditions rc.RouteConditions) {
